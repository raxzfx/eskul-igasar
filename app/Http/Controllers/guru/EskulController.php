...
class eskulController extends Controller
{
    ...
    public function index(Request $request)
    {
     ...
     return $query->where('nama_eskul', 'like', "%$search%");
         ...
         return view('guru.eskulTable',compact('eskul'));
    }
    ...
    {
        $guru = Guru::all();
        return view('guru.eskulAdd',compact('guru'));
    }
    ...
    return redirect()->route('guru.eskulTable')->with('success', 'Data kegiatan eskul berhasil ditambahkan');
    }
    ...
    public function edit(string $id)
    {
        ...
        $guru = Guru::all();
        return view('guru.eskulEdit',compact('eskul','guru'));
    }
    ...
    return redirect()->route('guru.eskulTable')->with('success', 'Data Eskul berhasil diupdate');
    }
    ...
    public function destroy(string $id)
    {
        $eskul = Eskul::findOrFail($id);
        $eskul->delete();
        return redirect()->route('guru.eskulTable')->with('success','data berhasil terhapus');
    }
}

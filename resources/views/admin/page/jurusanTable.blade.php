...
<div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
  <!-- Search -->
<form method="GET" action="{{ route('admin.jurusan.index') }}" class="navbar-nav align-items-center me-auto">
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="{{route('admin.jurusan.edit', $jurus->id_jurusan)}}">
                              <i class="icon-base bx bx-edit-alt me-1"></i> Edit
                          </a>
                          <form action="{{ route('admin.jurusan.destroy', $jurus->id_jurusan ) }}" method="POST" class="d-inline delete-form">
                            @csrf
                            @method('DELETE')

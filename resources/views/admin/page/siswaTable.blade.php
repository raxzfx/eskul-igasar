...
<div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
  <!-- Search -->
<form method="GET" action="{{ route('siswaTable') }}" class="navbar-nav align-items-center me-auto">
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="{{route('siswaEdit', $sis->id_siswa)}}">
                              <i class="icon-base bx bx-edit-alt me-1"></i> Edit
                          </a>
                          <form action="{{ route('siswaDestroy', $sis->id_siswa ) }}" method="POST" class="d-inline delete-form">
                            @csrf
                            @method('DELETE')

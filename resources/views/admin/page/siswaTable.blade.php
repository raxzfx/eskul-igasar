...
<div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
  <!-- Search -->
<form method="GET" action="{{ route('admin.siswa.index') }}" class="navbar-nav align-items-center me-auto">
              ...
              <table class="table table-hover">
                ...
                <tbody class="table-border-bottom-0">
                  ...
                  <tr>
                    ...
                    <td>{{$sis->no_telp}}</td>
                    <td>{{ $sis->jurusan->nama_jurusan}}</td>
                    <td>{{$sis->tingkat_kelas}}</td>
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="{{route('admin.siswa.edit', $sis->id_siswa)}}">
                              <i class="icon-base bx bx-edit-alt me-1"></i> Edit
                          </a>
                          <form action="{{ route('admin.siswa.destroy', $sis->id_siswa ) }}" method="POST" class="d-inline delete-form">
                            @csrf
                            @method('DELETE')

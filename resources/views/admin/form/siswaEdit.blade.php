...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="col-xxl">
    <div class="card">
      ...
      <div class="card-body">
        <form class="needs-validation" action="{{ route('admin.siswa.update', $siswa->id_siswa) }}" method="POST" novalidate>
          @csrf
          @method('put')
          <!-- Nama Lengkap -->
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group has-validation">
                ...
                <input type="text" class="form-control" id="name" name="nama_siswa" placeholder="Masukan nama lengkap..." value="{{ $siswa->nama_siswa }}"  />
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group has-validation">
                <span class="input-group-text"><i class="bx bx-user"></i></span>
                <input type="text" class="form-control" id="name" name="nama_siswa" placeholder="Masukan nama lengkap..." value="{{ $siswa->username }}"  />
                <div class="invalid-feedback">Nama lengkap harus diisi.</div>
              </div>
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group has-validation">
                ...
                <input type="number" class="form-control" id="phone" name="no_telp" value="{{ $siswa->no_telp }}" placeholder="Masukan nomor telepon..."  />
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <select class="form-select" id="jurusan" name="nama_jurusan" >
            <option value="" disabled>Pilih Jurusan</option>
            @foreach ($jurusan as $jurus)
                <option value="{{ $jurus->id_jurusan }}" 
                    {{ $siswa->id_jurusan == $jurus->id_jurusan ? 'selected' : '' }}>
                    {{ $jurus->nama_jurusan }}
                </option>
            @endforeach
        </select>
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <select class="form-select" id="tingkat_kelas" name="tingkat_kelas" >
            ...
            <option value="10" {{ $siswa->tingkat_kelas == 10 ? 'selected' : '' }}>X</option>
            <option value="11" {{ $siswa->tingkat_kelas == 11 ? 'selected' : '' }}>XI</option>
            <option value="12" {{ $siswa->tingkat_kelas == 12 ? 'selected' : '' }}>XII</option>
        </select>
    ...
    <div class="col-sm-10">
        <div class="input-group input-group-merge">
            <input type="password" id="password" class="form-control" name="password" 
                   placeholder="Masukkan password" aria-describedby="password" value="{{$siswa->password}}" novalidate />

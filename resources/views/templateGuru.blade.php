...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <a href="{{route('guru.homepage')}}" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{route('guru.guruTable')}}" class="menu-link">
            <div class="text-truncate" data-i18n="Badges">guru</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="{{route('guru.eskulTable')}}" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{route('guru.confirmTable')}}" class="menu-link">
            <div class="text-truncate" data-i18n="Perfect Scrollbar">Confirm Pendaftaran</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="{{route('guru.absensiTable')}}" class="menu-link">

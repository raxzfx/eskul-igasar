...
<div class="app-brand justify-content-center mb-6 text-center">
    <a href="index.html" class="app-brand-link d-block">
      ...
      <span class="app-brand-text demo text-heading fw-bold d-block">Register</span>
            ...
            <!-- /Logo -->
            <h4 class="mb-1">Daftar akun disini!</h4>
            ...
            <form id="formAuthentication" class="mb-6" action="index.html">
              <div class="mb-6">
                ...
                <input type="text" class="form-control" id="username" name="username" placeholder="masukan nama lengkap anda" autofocus />
              </div>
              <div class="mb-6">
              ...
              <div class="mb-6">
                <label for="exampleFormControlSelect1" class="form-label">Tingkat kelas</label>
                <select class="form-select" id="exampleFormControlSelect1" aria-label="Default select example">
              ...
              <div class="mb-6">
                ...
                <input type="number" class="form-control" id="email" name="email" placeholder="masukan no telp anda" />
              </div>

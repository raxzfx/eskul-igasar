...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="col-xxl">
    <div class="card">
      ...
      <div class="card-body">
        <form class="needs-validation" action="{{ route('guru.guruUpdate', $guru->id_guru) }}" method="POST" novalidate>
          @csrf
          @method('put')
          <!-- Nama Lengkap -->
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group has-validation">
                ...
                <input type="number" class="form-control" id="phone" name="no_telp" value="{{$guru->no_telp}}" placeholder="Masukan nomor telepon..." required />
          ...
          <!-- Select Jurusan -->
          <div class="row mb-3">
            <label class="col-sm-2 col-form-label" for="jurusan">role</label>
            <div class="col-sm-10">
              <select class="form-select" id="jurusan" name="role" required>
                <option value="" disabled selected>Pilih role</option>
                <option value="kesiswaan"{{$guru->role == 'kesiswaan' ? 'selected' : ''}}>kesiswaan</option>
                <option value="pembina"{{$guru->role == 'pembina' ? 'selected' : ''}}>pembina</option>
              </select>
    ...
    <div class="col-sm-10">
        <div class="input-group input-group-merge">
            <input type="password" id="password" class="form-control" name="password" 
                   placeholder="Masukkan password" aria-describedby="password" value="{{$guru->password}}" novalidate />

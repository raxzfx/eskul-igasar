...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="col-xxl">
    <div class="card">
      ...
      <div class="card-body">
        <form class="needs-validation" action="{{ route('guru.guruStore') }}" method="POST" novalidate>
          @csrf
          <!-- Nama Lengkap -->
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group has-validation">
                ...
                <input type="text" class="form-control" id="name" name="nama_guru" placeholder="Masukan nama lengkap..." required />

...
<div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
  <!-- Search -->
<form method="GET" action="{{ route('guru.absensiTable') }}" class="navbar-nav align-items-center me-auto">
...
<!-- / Navbar -->
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form action="{{ route('guru.absensiTable') }}" method="GET" class="d-flex gap-2 mb-3 " style="max-width: 130px;">
        ...
        <div class="card mb-4">
            <h5 class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('guru.absensiAdd', ['eskul_id' => $eskul->id_eskul]) }}" class="btn btn-primary">

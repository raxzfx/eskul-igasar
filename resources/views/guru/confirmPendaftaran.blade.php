...
<div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
  <!-- Search -->
<form method="GET" action="{{ route('guru.confirmTable') }}" class="navbar-nav align-items-center me-auto">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <!-- Form untuk Approve -->
                                        <form action="{{ route('guru.updateStatus', [$daftar->id_pendaftaran, $eskul->id_eskul]) }}" method="POST">
                                            @csrf
                                            @method('PATCH')

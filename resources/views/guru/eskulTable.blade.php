...
<div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
  <!-- Search -->
<form method="GET" action="{{ route('guru.eskulTable') }}" class="navbar-nav align-items-center me-auto">
            ...
            <a class="dropdown-item" href="#">
              <div class="d-flex">
                ...
                <div class="flex-grow-1">
                  <h6 class="mb-0">{{ Auth::guard('guru')->user()->username }}</h6> 
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <h5 class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{route('guru.guruAdd')}}" class="btn btn-primary">
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="{{route('guru.eskulEdit', $kul->id_eskul)}}">
                              <i class="icon-base bx bx-edit-alt me-1"></i> Edit
                          </a>
                          <form action="{{ route('guru.eskulDelete', $kul->id_eskul ) }}" method="POST" class="d-inline delete-form">
                            @csrf
                            @method('DELETE')

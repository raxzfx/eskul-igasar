...
<div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
  <!-- Search -->
<form method="GET" action="{{ route('guru.guruTable') }}" class="navbar-nav align-items-center me-auto">
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="{{route('guru.guruEdit', $gu->id_guru)}}">
                              <i class="icon-base bx bx-edit-alt me-1"></i> Edit
                          </a>
                          <form action="{{ route('guru.guruDelete', $gu->id_guru ) }}" method="POST" class="d-inline delete-form">
                            @csrf
                            @method('DELETE')
